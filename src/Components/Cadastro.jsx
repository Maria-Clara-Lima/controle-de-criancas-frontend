    ...
    <div>
      <form className="cadastro-form">
        ...
        <div className="form-group">
          <label htmlFor="nomeCrianca">Nome da criança (completo):  <span className="required">*</span>
             </label>
          <input
            type="text"
            id="nomeCrianca"
        ...
        <div className="form-group">
          <label htmlFor="dataNascimento">Data de Nascimento: <span className="required">*</span>
          </label>
          <input
            type="text"
            id="dataNascimento"
        ...
        {/* Seleção de Sala */}
        <div className="form-group">
          <label htmlFor="sala">Sala: <span className="required">*</span>
          </label>
        ...
        <div className="form-group">
          <label htmlFor="responsavel1">Nome do responsável 1: <span className="required">*</span>
          </label>
          <input
            type="text"
            id="responsavel1"
        ...
        <div className="form-group">
          <label htmlFor="telefone1">Telefone do responsável 1: <span className="required">*</span>
          </label>
          <input
            type="tel"
            id="telefone1"
        ...
        {/* Parentesco 1 */}
        <div className="form-group">
          <label htmlFor="parentesco1">Parentesco do responsável 1: <span className="required">*</span>
          </label>
          <input
            type="text"
            id="parentesco1"
        ...
        {/* Checkbox para tipo */}
        <div className="form-group">
          <label>Marque uma opção: <span className="required">*</span>
          </label>
